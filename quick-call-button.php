...
function qcb_display_contact_buttons($atts) {
    $atts = shortcode_atts([
        'zalo_phone' => '0344341021',
        'zalo_label' => 'Liên hệ Zalo',
        'messenger_link' => 'https://messenger.com/e2ee/t/7266697453382901',
...
add_action('wp_footer', function() {
    $zalo_phone = get_option('qcb_zalo_phone', '0344341021');
    $zalo_label = get_option('qcb_zalo_label', 'Liên hệ Zalo');
    $messenger_link = get_option('qcb_messenger_link', 'messenger.com/e2ee/t/7266697453382901');
